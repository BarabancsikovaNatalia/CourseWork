...
<f:view>
  <afh:html>
    ...
    <afh:body>
      <h:form>
        <af:panelPage title="Enter or delete data about Contracticing Parties (company)">
          <f:facet name="menu1">
            <af:menuTabs>
          ...
          <f:facet name="menu2">
            <af:menuBar>
              ...
              <af:commandMenuItem text="Contracting Parties (company)"
                                  action="company" selected="true"/>
              <af:commandMenuItem text="Contracts" action="contract1"/>
            </af:menuBar>
          </f:facet>
        </af:panelPage>
      </h:form>
