...
<f:view>
  <afh:html>
    ...
    <afh:body>
      <h:form>
        <af:panelPage title="Enter or delete data about Contracticing Parties (person)">
          <f:facet name="menu1">
            <af:menuTabs>
          ...
          <f:facet name="menu2">
            <af:menuBar>
              <af:commandMenuItem text="Contracting Parties (person)" selected="true"/>
              <af:commandMenuItem text="Contracting Parties (company)"
                                  action="company"/>
              <af:commandMenuItem text="Contracts" action="contract"/>
            </af:menuBar>
          </f:facet>
        </af:panelPage>
      </h:form>
