...
public class _pageForGebts extends com.orionserver.http.OrionHttpJspPage {
                                ...
                                do {
                                  out.write(__oracle_jsp_text[13]);
                                  {
                                    ...
                                    if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                                    {
                                      ...
                                      {
                                        oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag __jsp_taghandler_13=(oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag)OracleJspRuntime.getTagHandler(pageContext,oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag.class,"oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag text selected action");
                                        __jsp_taghandler_13.setParent(__jsp_taghandler_8);
                                        __jsp_taghandler_13.setText("Specialist in working with debt");
                                        __jsp_taghandler_13.setSelected("true");
