...
public class _pageForAdmin extends com.orionserver.http.OrionHttpJspPage {
                    ...
                    out.write(__oracle_jsp_text[10]);
                    {
                      ...
                      if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                      {
                        out.write(__oracle_jsp_text[11]);
                        {
                          ...
                          __jsp_taghandler_6.setTitle("Admin Page");
                                ...
                                do {
                                  out.write(__oracle_jsp_text[13]);
                                  {
                                    ...
                                    if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                                    {
                                      ...
                                      {
                                        oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag __jsp_taghandler_15=(oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag)OracleJspRuntime.getTagHandler(pageContext,oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag.class,"oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag text selected action");
                                        __jsp_taghandler_15.setParent(__jsp_taghandler_8);
                                        __jsp_taghandler_15.setText("Admin");
                                        __jsp_taghandler_15.setSelected("true");
