...
public class _references extends com.orionserver.http.OrionHttpJspPage {
                    ...
                    out.write(__oracle_jsp_text[10]);
                    {
                      ...
                      if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                      {
                        out.write(__oracle_jsp_text[11]);
                        {
                          ...
                          __jsp_taghandler_6.setTitle("Select Location or Department");
                                ...
                                do {
                                  out.write(__oracle_jsp_text[35]);
                                  {
                                    ...
                                    if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                                    {
                                      ...
                                      {
                                        oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag __jsp_taghandler_24=(oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag)OracleJspRuntime.getTagHandler(pageContext,oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag.class,"oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag text selected");
                                        __jsp_taghandler_24.setParent(__jsp_taghandler_23);
                                        __jsp_taghandler_24.setText("Reference Data");
                                        __jsp_taghandler_24.setSelected("true");
                                      ...
                                      {
                                        oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag __jsp_taghandler_25=(oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag)OracleJspRuntime.getTagHandler(pageContext,oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag.class,"oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag text action");
                                        __jsp_taghandler_25.setParent(__jsp_taghandler_23);
                                        __jsp_taghandler_25.setText("Job Types");
                                        __jsp_taghandler_25.setAction("jobs");
